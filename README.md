...
* The current phase 1 validation workflow is documented in [`notebooks/00_phase1_validation.ipynb`](https://github.com/oosei25/gerry-dislocation-ensemble/blob/main/notebooks/00_phase1_validation.ipynb). 
